package com.wangyueche.controller.admin;
...
public class SecurityController extends BaseController {
    ...
    public EasyUIResult queryForPage(@RequestParam(value = "page", defaultValue = "1") int page,
                                     @RequestParam(value = "rows", defaultValue = "10") int pageSize,
                                     @RequestParam(value = "organizationId", required = false) Long organizationId,
                                     @RequestParam(value = "name", required = false) String name,
                                     @RequestParam(value = "staffNo", required = false) String staffNo,
                                     @RequestParam(value = "organizationName", required = false) String organizationName) {
        Pager pager = new Pager(page, pageSize, 0, 1);
        EasyUIResult result = biz.listForPage(pager, organizationId, name, staffNo, organizationName);
