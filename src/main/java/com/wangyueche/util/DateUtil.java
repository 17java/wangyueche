...
public final class DateUtil {
	 ...
	 * @param numFormat 需要返回的长整形数字格式
	 * @return
	 */
	public static Long parseString(String dateString, String format,String numFormat) {
		SimpleDateFormat sdf = new SimpleDateFormat(format);
		try {
			Date date1 = sdf.parse(dateString);
			SimpleDateFormat numSdf = new SimpleDateFormat(numFormat);
			String numString = numSdf.format(date1);
