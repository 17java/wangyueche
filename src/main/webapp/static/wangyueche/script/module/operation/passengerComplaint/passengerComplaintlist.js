...
(function ($) {
    ...
    passengerComplaintlist.prototype = {
        ...
        loadGridTitle: function () {
            ...
            _self.listTypeShow = [[
                {
                    field: 'complaintTime', title: '投诉时间', width: '17%', formatter: function (value, row, index) {
                    return (value == null ? '' : cLib.base.getLocalTime(value));
                }
                },
                {field: 'detail', title: '投诉内容', width: '40%'},
        ...
        loadDataGrid: function (data) {
            ...
            _self.listView.datagrid({
                ...
                //url路径识别不了
                url: '/wangyueche/operation/passengerComplaint/list',// 加载的URL
                method: 'get',
                isField: "id",
